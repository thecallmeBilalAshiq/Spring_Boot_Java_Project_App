      ...
      <div className="center-container"style={{marginTop:"7rem"}}>
        ...
        <form className="row g-3 pt-1" onSubmit={handleSubmit}>
          ...
          <div className="col-md-6">
            ...
            <option value="Wheat Bran (Chokker)">Wheat Bran (Chokker)</option>
            <option value="Refined Flour (Maidda)">Refined Flour (Maidda)</option>
            <option value="Granulated Wheat(Soojji)">Granulated Wheat(Soojji)</option>
            </select>
          </div>
